const CACHE = 'sodium-shell-v56-sessionstate-guide-v11';
const GUIDE_PAGES = Array.from({ length:4 }, (_, index) => `./docs/guide-v11/page-${String(index + 1).padStart(2, '0')}.jpg`);
const SHELL = ['./', './index.html', './styles.css?v=56-sessionstate', './app.js?v=56-sessionstate-guide11', './manifest.webmanifest', './icon.svg', './icon-180.png', './icon-192.png', './icon-512.png', './icon-ink.svg', './icon-amber.svg', './icon-foam.svg', './icon-ocean.svg', './docs/SODIUM_Quick_Start_Guide_V11.pdf', ...GUIDE_PAGES];
