const CACHE = 'sodium-shell-v61-notification-update-card';
const GUIDE_PAGES = Array.from({ length:4 }, (_, index) => `./docs/guide-v13/page-${String(index + 1).padStart(2, '0')}.jpg`);
const SHELL = ['./', './index.html', './styles.css?v=61-notification-update-card', './app.js?v=61-notification-update-card', './manifest.webmanifest', './icon.svg', './icon-180.png', './icon-192.png', './icon-512.png', './icon-ink.svg', './icon-amber.svg', './icon-foam.svg', './icon-ocean.svg', './docs/SODIUM_Quick_Start_Guide_V13.pdf', './docs/SODIUM_App_Overview_One_Pager_V9.png', './docs/SODIUM_Setup_One_Pager_V2.png', './docs/SODIUM_Plan_A_Surf_One_Pager_V1.png', './docs/SODIUM_Get_Your_Clips_One_Pager_V1.png', ...GUIDE_PAGES];
