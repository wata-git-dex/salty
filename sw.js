const CACHE = 'sodium-shell-v59-clip-deliveries';
const GUIDE_PAGES = Array.from({ length:4 }, (_, index) => `./docs/guide-v12/page-${String(index + 1).padStart(2, '0')}.jpg`);
const SHELL = ['./', './index.html', './styles.css?v=59-clip-deliveries', './app.js?v=59-clip-deliveries', './manifest.webmanifest', './icon.svg', './icon-180.png', './icon-192.png', './icon-512.png', './icon-ink.svg', './icon-amber.svg', './icon-foam.svg', './icon-ocean.svg', './docs/SODIUM_Quick_Start_Guide_V12.pdf', './docs/SODIUM_App_Overview_One_Pager_V8.png', './docs/SODIUM_Setup_One_Pager_V1.png', ...GUIDE_PAGES];
