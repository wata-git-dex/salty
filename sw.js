const CACHE = 'salty-shell-v50-security1-guide-v8';
const GUIDE_PAGES = Array.from({ length:4 }, (_, index) => `./docs/guide-v8/page-${String(index + 1).padStart(2, '0')}.jpg`);
const SHELL = ['./', './index.html', './styles.css?v=50-security1', './app.js?v=50-security1', './manifest.webmanifest', './icon.svg', './icon-ink.svg', './icon-amber.svg', './icon-foam.svg', './icon-ocean.svg', './docs/SALTY_Quick_Start_Guide_V8.pdf', ...GUIDE_PAGES];
